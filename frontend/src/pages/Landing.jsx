...
import {
  ArrowUpRight, Sparkle, Brain, ChartLineUp, Target,
...
const FloatNote = ({ icon: Icon, label, value, delay = 0, x, y }) => (
  <motion.div
    ...
    style={{ left: x, top: y }}
    className="absolute hidden md:flex items-center gap-3 backdrop-blur-xl bg-white/[0.04] border border-white/[0.08] px-4 py-3 z-30 shadow-2xl"
  >
...
const DashboardMock = () => (
  <div className="relative">
    {/* glow */}
    <div className="absolute -inset-8 bg-gradient-to-br from-[#8B5CF6]/10 via-blue-500/5 to-transparent blur-3xl pointer-events-none" />

    <motion.div
      initial={{ opacity: 0, y: 40, rotateY: -8 }}
      animate={{ opacity: 1, y: 0, rotateY: 0 }}
      transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1], delay: 0.2 }}
      className="relative backdrop-blur-2xl bg-[#0F172A]/70 border border-white/[0.07]"
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="border border-white/[0.06] p-4">
          <div className="flex items-center justify-between mb-3">
            <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500">AI CAREER MATCH</div>
              ...
              <div key={role}>
                ...
                <div className="h-[2px] bg-white/[0.04] overflow-hidden">
                  <motion.div
                    ...
                    className="h-full bg-gradient-to-r from-[#8B5CF6] to-[#A3FF12]"
                  />
                </div>
              </div>
            ))}
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="border border-white/[0.06] p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500">SKILL GAP</div>
          ...
          <div className="border border-white/[0.06] p-4">
            <div className="flex items-center justify-between mb-3">
              <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500">ROADMAP · Q1</div>
            ...
            <div className="space-y-1.5 text-[11px]">
              {[
                ...
                <div key={m} className="flex gap-2 items-center">
                  <span className="font-mono text-slate-600 text-[9px]">{m}</span>
        ...
        {/* Live jobs feed */}
        <div className="border border-white/[0.06] p-4">
          <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-3">LIVE JOBS · 14 NEW</div>
            ...
            {[
              ...
              >
                <div className="min-w-0">
                  ...
                  <div className="text-slate-600 font-mono text-[10px]">{co} · {sal}</div>
                </div>
    ...
    <FloatNote icon={Sparkle} label="OPPORTUNITY" value="14 new jobs matched" delay={1.0} x="-80px" y="40px" />
    <FloatNote icon={ChartLineUp} label="RESUME ATS" value="Score +12 → 94/100" delay={1.3} x="-50px" y="auto" />
    <div className="hidden md:block absolute right-[-30px] top-[80px]">
      <FloatNote icon={Robot} label="CAREER TWIN" value="This week's brief ready" delay={1.6} x="0" y="0" />
    </div>
    <div className="hidden md:block absolute right-[-40px] bottom-[20px]">
  ...
  <nav className="hidden md:flex items-center gap-1 text-sm">
    {items.map((it) => (
      <a key={it.href} href={it.href}
        className="px-4 py-2 text-slate-400 hover:text-white transition-colors relative group">
        <span>{it.label}</span>
  ...
  return (
    <div className="min-h-screen bg-[#070B14] text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[800px] bg-gradient-radial from-[#8B5CF6]/[0.08] via-transparent to-transparent blur-3xl" />
      ...
      <header className="relative z-50">
        ...
        >
          <div className="flex items-center justify-between backdrop-blur-2xl bg-[#0F172A]/60 border border-white/[0.08] px-5 py-3 rounded-full shadow-xl shadow-black/40">
            <Link to="/" className="flex items-center gap-2.5" data-testid="landing-logo">
              ...
              <span className="font-display text-base font-extrabold tracking-tight">Margdarshak Sathi AI</span>
            </Link>
            <PillNav items={[
            ...
            <div className="flex items-center gap-2">
              <Link to="/login" className="text-sm text-slate-300 hover:text-white px-3 py-1.5" data-testid="header-signin">
                Sign In
              </Link>
              <Link to="/login"
                className="group bg-[var(--accent)] hover:bg-[#A78BFA] text-white text-sm font-bold px-4 py-2 rounded-full flex items-center gap-1.5 transition-all hover:shadow-[0_0_30px_rgba(215,255,0,0.4)]"
            ...
            <div className="lg:col-span-6 relative z-10">
              ...
              >
                ...
                <span className="relative inline-block">
                  <span className="bg-gradient-to-br from-[#8B5CF6] via-[#3B82F6] to-[#A3FF12] bg-clip-text text-transparent">
                    operating system.
                  </span>
                  <span className="absolute inset-0 bg-gradient-to-br from-[#8B5CF6] via-[#3B82F6] to-[#A3FF12] bg-clip-text text-transparent blur-[12px] opacity-30">
                    operating system.
                  </span>
                </span>
              </motion.h1>
              ...
              >
                Margdarshak Sathi AI analyzes your resume, audits your GitHub, tracks industry
              ...
              >
                <Link to="/login"
                  ...
                  className="group relative bg-[var(--accent)] hover:bg-[#A78BFA] text-white font-bold px-6 py-3.5 rounded-full flex items-center gap-2 transition-all hover:shadow-[0_0_50px_rgba(215,255,0,0.5)]">
                ...
                <a href="#features"
                  ...
                  className="backdrop-blur-md bg-white/[0.03] border border-[rgba(255,255,255,0.08)] hover:border-white/30 hover:bg-white/[0.06] text-white px-6 py-3.5 rounded-full flex items-center gap-2 transition-all">
                  <Play size={14} weight="fill" />
                  Watch AI Demo
                </a>
              </motion.div>

              {/* trust strip - real user benefits */}
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                {[
                  { v: "AI Analysis", l: "Resume & GitHub" },
                  { v: "Real Jobs", l: "JSearch & Adzuna" },
                  { v: "Voice AI", l: "Mock Interviews" },
                ].map((s, i) => (
                  <div key={i}>
                    <div className="font-display text-2xl lg:text-3xl font-black tracking-tight text-purple-400">{s.v}</div>
      ...
      {/* Capability strip */}
      <section className="relative border-y border-white/[0.06] backdrop-blur-sm bg-[#0F172A]/40">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-6 flex items-center gap-12 overflow-x-auto">
          <span className="text-[10px] font-mono uppercase tracking-widest text-slate-500 shrink-0">POWERED BY</span>
          {["Gemini 2.5 Flash", "ElevenLabs Voice", "Deepgram Nova-3", "Qdrant Vectors", "LangGraph Agents", "JSearch · Adzuna", "GitHub API"].map((t) => (
            <span key={t} className="text-sm text-slate-400 whitespace-nowrap font-mono">{t}</span>
          ))}
        </div>
      </section>
      ...
      <section id="features" className="relative py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-3xl mb-16">
            <div className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-4">
            ...
            <h2 className="font-display text-4xl lg:text-6xl font-black tracking-[-0.04em] leading-[1]">
              One console.<br />
              <span className="text-slate-500">Every career decision.</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/[0.05] border border-white/[0.05]">
            {features.map((f, i) => (
              <motion.div
                ...
                className="bg-[#0F172A] p-8 group hover:bg-[#0F172A] transition-colors relative overflow-hidden"
                data-testid={`feature-${i}`}
              >
                <div className="absolute top-6 right-6 text-[10px] font-mono text-slate-700 group-hover:text-[var(--accent)] transition-colors">
                  {f.k}
                </div>
      ...
      <section id="twin" className="relative py-24 lg:py-32 border-t border-white/[0.05]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="backdrop-blur-2xl bg-[#0F172A]/60 border border-white/[0.07] p-8 relative overflow-hidden">
              <div className="absolute -inset-1 bg-gradient-to-br from-[#8B5CF6]/[0.06] to-transparent pointer-events-none" />
              <div className="relative">
                <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-4">WEEK OF 11 FEB · 2026</div>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-6">
                  {[
                    ...
                    <div key={k} className="border border-white/[0.06] p-4">
                      <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-2">{k}</div>
      ...
      <section id="interview" className="relative py-24 lg:py-32 border-t border-white/[0.05]">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 order-2 lg:order-1">
            <div className="backdrop-blur-2xl bg-[#0F172A]/60 border border-white/[0.07] p-8 relative">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500">DANIEL · FAANG LEAD</div>
              ...
              <div className="border-l-2 border-[var(--accent)] pl-4 mb-4">
                <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-1">Q3 · INTERVIEWER</div>
                <p className="text-slate-200">How would you scale a LangGraph supervisor for 1M concurrent agent runs?</p>
              </div>
      ...
      <section className="relative py-32 lg:py-40 border-t border-white/[0.05]">
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-10 text-center">
          ...
          <h2 className="font-display text-5xl lg:text-7xl font-black tracking-[-0.04em] leading-[1]">
            Stop guessing.<br />Start <span className="bg-gradient-to-br from-[#8B5CF6] to-[#A3FF12] bg-clip-text text-transparent">shipping</span>.
          </h2>
          ...
          <div className="mt-10">
            <Link to="/login" data-testid="footer-cta"
              className="group inline-flex items-center gap-2 bg-[var(--accent)] hover:bg-[#A78BFA] text-white font-bold px-7 py-4 rounded-full transition-all hover:shadow-[0_0_60px_rgba(215,255,0,0.5)]">
              <RocketLaunch size={20} weight="bold" /> Launch Margdarshak Sathi AI
      ...
      {/* Contact Section */}
      <section id="contact" className="relative border-t border-white/[0.05] py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-4">
              <span className="block w-3 h-px bg-[var(--accent)]" /> GET IN TOUCH
            </div>
            <h2 className="font-display text-4xl lg:text-5xl font-black tracking-[-0.04em] mb-8">
              Contact <span className="bg-gradient-to-br from-[#8B5CF6] to-[#A3FF12] bg-clip-text text-transparent">Chaudhari Brothers</span>
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="space-y-6">
                <div className="text-left">
                  <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-2">Phone</div>
                  <div className="space-y-2">
                    <div className="text-lg text-slate-200">9518391245</div>
                    <div className="text-lg text-slate-200">7249784719</div>
                  </div>
                </div>
                
                <div className="text-left">
                  <div className="text-[10px] font-mono uppercase tracking-widest text-slate-500 mb-2">Email</div>
                  <div className="space-y-2">
                    <a href="mailto:tarunchaudhari1313@gmail.com" className="text-lg text-purple-400 hover:text-purple-300 transition-colors block">
                      tarunchaudhari1313@gmail.com
                    </a>
                    <a href="mailto:gauravmchaudhari2005@gmail.com" className="text-lg text-purple-400 hover:text-purple-300 transition-colors block">
                      gauravmchaudhari2005@gmail.com
                    </a>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center">
              <div className="inline-flex items-center gap-2 backdrop-blur-md bg-[var(--accent)]/10 border border-[var(--accent)]/20 px-6 py-3 rounded-full">
                <Sparkle size={16} weight="bold" className="text-[var(--accent)]" />
                <span className="text-sm text-white font-bold">Made by Chaudhari Brothers❤️</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="relative border-t border-white/[0.05] py-10">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-4 text-[10px] font-mono uppercase tracking-widest text-slate-600">
          <div>© 2026 · MARGDARSHAK SATHI AI · MADE BY CHAUDHARI BROTHERS❤️</div>
